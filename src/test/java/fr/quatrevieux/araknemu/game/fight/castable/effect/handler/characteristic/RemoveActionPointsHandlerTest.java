...
class RemoveActionPointsHandlerTest extends FightBaseCase {
    private Fight fight;
    private PlayerFighter caster;
    private PlayerFighter target;
    private RemoveActionPointsHandler handler;
    ...
    public void setUp() throws Exception {
        ...
        handler = new RemoveActionPointsHandler(fight);
    ...
    void handleWillRemoveToCurrentTurn() {
        ...
        requestStack.assertLast(ActionEffect.removeActionPoints(caster, 3));
    ...
    void buff() {
        ...
        Mockito.when(effect.effect()).thenReturn(168);
    ...
    void onBuffStartedAndTerminatedOnTarget() {
        ...
        assertEquals(3, target.characteristics().get(Characteristic.ACTION_POINT));
    ...
    void onBuffStartedAndTerminatedOnCaster() {
        ...
        requestStack.assertLast(ActionEffect.buff(buff, -3));
        assertEquals(3, caster.characteristics().get(Characteristic.ACTION_POINT));
        assertEquals(3, caster.turn().points().actionPoints());
